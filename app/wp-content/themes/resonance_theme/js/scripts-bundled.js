...
function () {
  ...
  _createClass(Search, [{
    ...
    value: function events() {
      ...
      (0, _jquery.default)(document).on("keydown", this.keyDispatcher.bind(this));
    ...
    value: function getResults() {
      ...
      _jquery.default.getJSON(reiData.root_url + '/wp-json/rei/v1/search?term=' + this.searchField.val(), function (results) {
        _this.resultsDiv.html("\n            <div class=\"row\">\n                <div class=\"col-1-of-3\">\n                    <h2 class=\"search-overlay__section-title\">General Information</h2>\n                    ".concat(results.generalInfo.length ? '<ul class="link-list min-list">' : '<p> No General information found </p>', "\n                    ").concat(results.generalInfo.map(function (item) {
          ...
          return "<li>\n                                                        <a href=\"".concat(item.permalink, "\">").concat(item.title, "</a>\n                                                        </li>");
        }).join(''), "\n                    ").concat(results.programs.length ? '</ul>' : '', "\n\n\n                    <h2 class=\"search-overlay__section-title\">Professors</h2>\n                    ").concat(results.professors.length ? '<ul class="person-cards">' : "<p>No professors match that search.</p>", "\n                      ").concat(results.professors.map(function (item) {
          return "\n                        <li class=\"person-card__list-item\">\n                          <a class=\"person-card\" href=\"".concat(item.permalink, "\">\n                            <img class=\"person-card__image\" src=\"").concat(item.image, "\">\n                            <span class=\"person-card__name\">").concat(item.title, "</span>\n                          </a>\n                        </li>\n                      ");
    ...
    key: "keyDispatcher",
    value: function keyDispatcher(e) {
      /*
  ...
  _createClass(MyNotes, [{
    ...
    value: function deleteNote(e) {
      ...
      _jquery.default.ajax({
        ...
        url: reiData.root_url + '/wp-json/wp/v2/note/' + thisNote.data('id'),
        type: 'DELETE',
